...
def solve():
    ...
    def fill_result(s_index, f_index, rest):
        ...
        r_result = [''] * (f_index - s_index + 1)

        if f_index - s_index < rest:
            r_result = total_number[s_index:f_index + 1]
        ...
        while rest != 0:
            ...
            fill_result_set = fill_result(s_index + curr_i + 1, f_index, rest)
            if fill_result_set:
                r_result[curr_i + 1:f_index + 1] = fill_result_set[0]
